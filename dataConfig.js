...
//1F热门目的地推荐设置
    if (root.hotSale) {
        ...
        $.extend(root.hotSale.big_ads_left.config, {
            "title": "广告左",
            "max": 1,
            "controller": "B_1",
            "picSize-x": 81,
        ...
        $.extend(root.hotSale.big_ads_top.config, {
            "title": "广告上",
            "max": 1,
            "controller": "B_1",
            "picSize-x": 85,
        ...
        $.extend(root.hotSale.big_ads_bottom.config, {
            "title": "广告下",
            "max": 1,
            "controller": "B_1",
            "picSize-x": 85,
        ...
        $.extend(root.hotSale.big_ads_right.config, {
            "title": "广告右",
            "max": 1,
            "controller": "B_1",
            "picSize-x": 81,
